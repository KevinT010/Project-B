public static class AccountVisibility
{
    ...
    private static void ShowUserMenu()
    {
        ...
        string[] options = { "Show reservations", "Menu", "Reservations", "Floor-plan", "Edit account", "Delete account", "Logout" };
    ...
    private static void ShowAdminMenu()
    {
        ...
        string[] options = { "Show all reservations", "Input menu", "Current menu", "Floor-plan", "Edit user account", "Delete user account", "Logout" };
